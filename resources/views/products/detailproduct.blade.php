              ...
              <div class="x_panel">
                ...
                <form id="form-editproduct" data-parsley-validate class="form-horizontal form-label-left" method="post">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                    	<input type="text" disabled class="form-control col-md-7 col-xs-12" id="product_name" name="product_name" aria-describedby="product_name" value="{{$data_product->product_name}}">
                    </div>
                  </div>
				  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="product_category">Kategori </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                    	<input type="text" disabled class="form-control col-md-7 col-xs-12" id="product_category" name="product_category" aria-describedby="product_category" value="{{$data_product->product_category}}">
                    </div>
                  </div>
				  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="product_weight">Berat </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                    	<input type="text" disabled class="form-control col-md-7 col-xs-12" id="product_weight" name="product_weight" aria-describedby="product_weight" value="{{$data_product->product_weight}}">
                    </div>
                  </div>
				  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="product_price">Harga </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                    	<input type="text" disabled class="form-control col-md-7 col-xs-12" id="product_price" name="product_price" aria-describedby="product_price" value="{{$data_product->product_price}}">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="product_desc">Deskripsi </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                    	<input type="text" disabled class="form-control col-md-7 col-xs-12" id="product_desc" name="product_desc" aria-describedby="product_desc" value="{{$data_product->product_desc}}">
                    </div>
				  </div>
				  <div class="form-group">
