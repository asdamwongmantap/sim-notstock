...
<footer>
          ...
          <a href="#">SIM-NOTSTOCK </a> - Sistem Informasi Manajemen Notifikasi Stock
          </div>
    ...
    <!-- sweet alert -->
    <script src="{{ asset('/assets/alert/js/sweetalert.min.js')}}"></script>
    <!-- Datatables -->
...
<script src="{{ asset('/assets/vendors/moment/min/moment.min.js')}}"></script>	
    ...
    <!-- <link rel="stylesheet" href="{{ asset('/js/jquery-ui.js')}}"> -->
